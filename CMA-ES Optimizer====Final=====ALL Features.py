...
# Print results
print("=== IMPROVED CMA-ES Regression = Post-Bladder volume at the first desire to void ===")
...
# Preprocess the dataset
X = df.drop('Post-Time to max flow', axis=1)
y = df['Post-Time to max flow']
...
# Print results
print("=== IMPROVED CMA-ES Regression = Post-Time to max flow ===")
print("Best Parameters:", best_params)
print("Mean Squared Error :", mse)
print("Mean Absolute Error:", mae)
print("R²-score           :", r2)
...
# Preprocess the dataset
X = df.drop('Post-Detrusor pressure at maximum flow rate', axis=1)
y = df['Post-Detrusor pressure at maximum flow rate']
